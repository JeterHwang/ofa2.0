...
from utils import get_same_padding, sub_filter_start_end, make_divisible, SEModule, MyNetwork, MyConv2d
...
class DynamicBatchNorm2d(nn.Module):
	...
	def bn_forward(x, bn: nn.BatchNorm2d, feature_dim):
		if bn.num_features == feature_dim or DynamicBatchNorm2d.SET_RUNNING_STATISTICS:
			...
			############### should delete "or not bn.track_running_stats" ###########
			return F.batch_norm(
	...
	def forward(self, x):
		feature_dim = x.size(1) # channel size 
